...
namespace Contract {
    ...
    export type Contract = {
        ...
        */
         ...
         * Contract detail
         */
        contract_detail?: Detail | null

        /**
         * Contract bank account
         */
        contract_bank_account?: BankAccount | null

        /**
         * Contract virtual bank account
         */
        contract_virtual_bank?: Omit<BankAccount, "bank_name_kana" | "bank_code" | "branch_code" | "branch_name_kana" | "account_kind"> | null
     ...
     * - `107`: Contract succeeded
     */
    export type Status = 101 | 102 | 103 | 105 | 106 | 107
