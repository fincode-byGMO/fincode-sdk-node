...
namespace Tenant {
     ...
     */
    export type RegisteringResponse = {
        /**
         * Access token
         */
    ...
    export type UpdatingExaminationInfoRequest = {
         ...
         * Contract detail
         */
        contract_detail?: Partial<Contract.Detail> & Partial<Shop.SpecifiedCommercialTransactionActInfo> | null

        /**
         * Shop item detail
         */
        shop_item_detail?: Partial<Shop.ItemDetail>[] | null

        /**
         * Bank account
         */
        bank_account?: Partial<Contract.BankAccount> | null
    }
    ...
    export type ExaminationInfo = {
         ...
         */
        status_code: Shop.ContractStatus
         ...
         * Contract detail
         */
        contract_detail: Contract.Detail & Shop.SpecifiedCommercialTransactionActInfo

        /**
         * Shop item detail
         */
        shop_item_detail: Shop.ItemDetail[]

        /**
         * Bank account
         */
        contract_bank_account: Contract.BankAccount
