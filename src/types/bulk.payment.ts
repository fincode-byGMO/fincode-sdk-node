...
namespace BulkPayment {
     ...
     */
    export type BulkPaymentPagination = Pagination & {
        /**
     ...
     */
    export type DetailPagination = Pagination & {
        /**
         * Bulk payment ID.
         */
        id: string
     ...
     * - `ERROR`: Some error occurred.
     */
    export type Status = 'CHECKING' | 'CHECKED' | 'RUNNING' | 'COMPLETED' | 'ERROR'
     ...
     * - `FAILED`: Failed.
     */
    export type PaymentStatus = 'CHECKED' | 'SUCCEEDED' | 'FAILED'
}
